  ...
  return (
    <div className="flex flex-col p-4 rounded-md gap-4 bg-slate-950 sm:flex-wrap">
      <div className="flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4">
        <h4 className="text-3xl hidden sm:inline sm:text-4xl md:text-5xl font-semibold bg-slate-400">
          0{i + 1}
        </h4>
        <h2 className="capitalize whitepace-nowrap truncate max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center ">
